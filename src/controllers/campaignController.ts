...
export class CampaignController {
    async approveCampaign(req: Request, res: Response) {
        try {
            ...
            return CreateSuccessResponse(res, 200, { message: "Campaign approved", campaign });
        } catch (error) {
    ...
    async getAllCampaigns(req: Request, res: Response) {
        try {
            ...
            const isAccepted = req.query.isAccepted === "true" ? true : 
                             req.query.isAccepted === "false" ? false : undefined;
