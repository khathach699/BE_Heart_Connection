...
const router = Router();
router.get("/", check_authentication, Donate_CampaignController.getAllDonate as unknown as any);
router.post("/detail", Donate_CampaignController.getDonateById as unknown as any);
router.post("/", check_authentication, Donate_CampaignController.createDonate as unknown as any);
